...
# readers_df = df_for_csv("../../output/logit-w2v-readers.csv")
# literature_df = df_for_csv("../../output/logit-w2v-literature.csv")
# readers_df = df_for_csv("../../output/logit-w2v-docs-readers.csv")
# literature_df = df_for_csv("../../output/logit-w2v-docs-literature.csv")
readers_df = df_for_csv("../../output/logit-w2v-sents-readers.csv")
literature_df = df_for_csv("../../output/logit-w2v-sents-literature.csv")
...
vocab_level_a1_words = set(vocab_df[vocab_df["Level"] == "A1"]["Lexical item"])
vocab_level_a2_words = set(vocab_df[vocab_df["Level"] == "A2"]["Lexical item"])
vocab_level1_words = vocab_level_a1_words.union(vocab_level_a2_words)
