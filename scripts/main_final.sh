...
venv/bin/python main.py analyze-documents "data/vocabulary.csv" "data/readers/readers.csv"
venv/bin/python main.py analyze-documents "data/vocabulary.csv" "data/literature/literature.csv"
venv/bin/python main.py analyze-documents "data/vocabulary.csv" "data/native/native.csv"
